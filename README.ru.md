...
- Портреты персонажей из игровых ассетов

**Доски:**
- Разблокировка/блокировка любой доски
- Установка уровня (1-20) для каждой доски
- Иконки досок с информацией о владельце
...
**Флаги:**
- Переключение всех булевых флагов игры (аналитика, кампания, туториалы, реклама и др.)
- Сброс или установка отдельных флагов для настройки поведения игры

**Быстрые действия (массовые операции):**
- Разблокировать всё одним нажатием (серферы, скины, доски, валюта, сезонный пропуск, отключение рекламы)
...
- Отключить рекламу и разблокировать бонусные треки
- Пропустить туториал
...
CityEdit/
  ...
  images/                           Скриншоты и видео-туториал для README
  src/
    CityEdit/                       Общая библиотека и точка входа десктопа
      Assets/
        Icons/
          surfers/                  Портреты серферов (встроенные ресурсы)
          boards/                   Иконки досок (встроенные ресурсы)
      Core/
      ...
      Services/
        ...
        IconService.cs              Загрузчик встроенных иконок (схема avares://)
      ...
      ViewModels/
        ...
        Items/
          ItemViewModels.cs         VM отдельных элементов (серфер, доска, скин, валюта, стат, покупка, флаг)
      Views/
        ...
        SurfersView.axaml(.cs)      Список серферов с портретами и вложенными скинами
        BoardsView.axaml(.cs)       Список досок с иконками
        ...
        FlagsView.axaml(.cs)        Редактор булевых флагов игры
      Converters/
...
3. Редактируйте любые значения через интерфейс с вкладками (Quick Actions, Surfers, Boards, Stats, Wallet, Purchases, Season Pass, Flags).
...
- [ADrive](https://4pda.to/forum/index.php?showuser=8063499) - за исследование редактора сохранений и информацию о структуре игровых данных
